    ...
    <div class="w3-modal-content w3-animate-top w3-card-4">
        ...
        <header class="w3-container w3-deep-white">
            <div class="w3-bar" style="">
                ...
                <div class="w3-col s7 w3-bar-item" style="background:;text-align:center;" >
                    ...
                    <h3 style="margin:0px;text-align:center;"><b>Oficio de Comisión</b></h3>
        ...
        <input type="text" id = "idEmpleado" name ="idEmpleado" style="display:none;"value ="<?php echo $id; ?>">
          ...
          <section>
                <br>
                  <div class="w3-col s12" style="display:">
                     <div class="w3-col s3" style=":">
                        <div class="w3-container" style="width: 100%; height:80px; " id="">
                            <label for=""style="height: 30px; line-height: 50px; padding: 0;">Periodo de Comisión del:</label>
                        </div>
                    </div>
                    <div class="w3-col s3" style=":">
                        <div class="w3-container" style="width: 100%; height:80px; " id="">
                ...
                <div class="w3-col s8">
                    <div class="w3-container" style="width: 100%; height:80px; " id="">
                        <label for="objetoComision">Objeto de la Comisión</label><input type="text" name="objetoComision" id="objetoComision" class="w3-input w3-border-1"  required><br>
                    </div>
                </div>
                <div class="w3-col s12" style="display:">
                     <div class="w3-col s3" style=":">
                        <div class="w3-container" style="width: 100%; height:80px; " id="">
                            <label for=""style="height: 30px; line-height: 50px; padding: 0;">Medio de Transporte:</label>
                        </div>
                    </div>
                    <div class="w3-col s3" style=":">
                        <div class="w3-container" style="width: 100%; height:40px; " id="">
                          <label for="transporte1"style="height: 30px; line-height: 50px; padding: 0;">Vehiculo Oficial</label> <input type="checkBox" name="transporte1" id="transporte1" class="w3-check w3-border-1" value="Vehiculo Ofical">
                        </div>
                    </div>
                    <div class="w3-col s2" style=":">
                        <div class="w3-container" style="width: 100%; height:40px; " id="">
                          <label for="transporte2"style="height: 30px; line-height: 50px; padding: 0;">Autobus</label> <input type="checkBox" name="transporte2" id="transporte2" class="w3-check w3-border-1" value="Autobus">
                        </div>
                    </div>
                    <div class="w3-col s3" style=":">
                        <div class="w3-container" style="width: 100%; height:40px; " id="">
                          <label for="transporte3"style="height: 30px; line-height: 50px; padding: 0;">Vehiculo Propio</label> <input type="checkBox" name="transporte3" id="transporte3" class="w3-check w3-border-1" value="Vehiculo Propio">
                        </div>
                    </div>
                  ...
                  <div class="w3-col s8">
                    <div class="w3-container" style="width: 100%; height:80px; " id="">
                        <Label for="nombreSuplente">Nombre del Suplente: </Label><input type="text" name="nombreSuplente" id="nombreSuplente" class="w3-input w3-border-1" readonly="readonly" required><br>
                    </div>
                </div>
                <div class="w3-col s12" style="display:">
                    <div class="w3-col s3" style=":">
                        <div class="w3-container" style="width: 100%; height:80px; " id="">
                          <label for="trabajorAdscrito"style="height: 30px; line-height: 50px; padding: 0;">Trabajador Adscrito</label> <input type="checkBox" name="trabajorAdscrito" id="trabajorAdscrito" class="w3-check w3-border-1" value="trabajor Adscrito">
                        </div>
                    </div>
                    <div class="w3-col s4" style=":">
                        <div class="w3-container" style="width: 100%; height:80px; " id="">
                          <label for="trabajadorBolsaTrabajo"style="height: 30px; line-height: 50px; padding: 0;">Trabajador Bolsa de Trabajo</label> <input type="checkBox" name="trabajadorBolsaTrabajo" id="trabajadorBolsaTrabajo" class="w3-check w3-border-1" value="trabajador Bolsa de Trabajo">
                        </div>
                    </div>
                </div>
            ...
            <div class="w3-col s12" id="divObservaciones" style="display:">
                    <div class="w3-container" style="width: 100%; height:80px; " id="">
                        <label for="Dictamen">Digtamen:</label><textarea class="w3-input w3-border-1" id="Dictamen" name="Dictamen" rows="1" cols="4" maxlength="250" style="resize:none"></textarea><br>
                    </div>
                </div>
            ...
            <section>
               ...
               <div class="w3-col s4">
                ...
                <div class="w3-col s4">
                 ...
                 <div class="w3-col s4"> <!-- cuarta firma select -->
                    <div class="w3-container" style="width: 100%; height:80px; " id="">
                        <label>Persona Quien Autoriza:</Label>
                        <select class="w3-select" name="selectDivision" id="selectDivision" required>
                            <option value="" disabled selected>Selecciona una opción</option>
               ...
               <div class="w3-col s4"> <!-- sexta firma select -->
                ...
                <div class="w3-col s4"> <!-- firma empleado -->
                    <div class="w3-container firma" style="width: 100%; height:200px;" id="">
                        ...
                        <div style="display: flex; justify-content:center;">
                            <label id="cargoDivision">Dirección de División</label><br>
                        </div>
                    </div>
                </div>
                <div class="w3-col s4">  <!-- firma empleado -->
