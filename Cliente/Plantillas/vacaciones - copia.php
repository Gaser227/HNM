            ...
            <section>
                ...
                <div class="w3-col s4" style="display:">
                    <div class="w3-container" style="width: 100%; height:60px; " id="">
                        <label for="diasDisfrutar">Dias a Disfrutar: </label><input type="number" name="diasDisfrutar" id="diasDisfrutar" class="w3-input w3-border-1">
                    </div>
                </div>
                <div class="w3-col s4">
                    <div class="w3-container " style="width: 100%; height:80px;" id="">
                        <label for="periodo">Periodo:</Label>
                        <select class="w3-select w3-input w3-border-1" name="periodo" id="periodo" required>
                            <option value="" disabled selected>Selecciona una opción</option>
                ...
                <div class="w3-col s4"  style="display:">
                    ...
                    <select class="w3-select w3-input w3-border-1" id="anio" >
                ...
                <div class="w3-col s4">
                    <div class="w3-container" style="width: 100%; height:150px; " id="">
                        <!--<input type="submit" id="btnPeriodoActual" value="Periodo Actual" class="w3-button w3-green" style="margin-bottom:10px"-->
                        <label for="adscripcion">Periodo Actual:</label><input type="text" value="Julio-Diciembre" id="periodoActual" class="w3-input w3-border-1" readonly="readonly" required><br>
                    </div>
                </div>
                <!--Periodo anterior-->
                <div class="w3-col s4">
                    <div class="w3-container" style="width: 100%; height:150px; " id="">
                        <!--<input type="submit" id="btnPeriodoAnterior" value="Periodo Anterior" class="w3-button w3-green" style="margin-bottom:10px">-->    
                        <label for="adscripcion">Periodos Anteriores:</label>                         
                        <!-- <input type="submit" id="btnVerPeriodos" value="Periodos" class="w3-button w3-blue" style="margin-bottom:10px">-->
               ...
               <div class="w3-col s4"> <!-- tercer Firma select-->
                ...
                <div class="w3-col s4"> <!-- tercer firma  -->
                    <div class="w3-container firma" style="width: 100%; height:200px;" id="">
                        ...
                        <div style="display: flex; justify-content:center;">
                            <label id="firmaReviso">NOMBRE</label><br>
                        </div>
                        <div style="display: flex; justify-content:center;">
                            <label id="CargoReviso">Firma Coordinadora de Planeación y Desarrollo</label><br>
                        </div>
                    </div>
                </div>
                 <div class="w3-col s4"> <!-- cuarta firma select -->
                    <div class="w3-container" style="width: 100%; height:80px; " id="">
                        ...
                        <select class="w3-select" name="selectFirma[]" id="selectAdminPersonal" >
                            <option value="" disabled selected>Selecciona una opción</option>
                            
                        </select>
                    </div>
                </div>
                 <div class="w3-col s4"> <!-- quinta firma select -->
                    <div class="w3-container" style="width: 100%; height:80px; " id="">
                        <label>Persona Quien Autoriza:</Label>
                        <select class="w3-select" name="selectFirma[]" id="selectDivision" >
                            <option value="" disabled selected>Selecciona una opción</option>
               ...
               <div class="w3-col s4"> <!-- sexta firma select -->
                ...
                <div class="w3-col s4"> <!-- firma empleado -->
                    <div class="w3-container firma" style="width: 100%; height:200px;" id="">
                        ...
                        <div style="display: flex; justify-content:center;">
                            <label id="firmaCoordinadora">NOMBRE</label><br>
                        </div>
                        <div style="display: flex; justify-content:center;">
                            <label id="cargoCoordinadora">Firma Coordinadora de Área de Administración de Personal</label><br>
                        </div>
                    </div>
                </div>
                <div class="w3-col s4"> <!-- firma empleado -->
                    <div class="w3-container firma" style="width: 100%; height:200px;" id="">
                        ...
                        <div style="display: flex; justify-content:center;">
                            <label id="cargoCoordinadora">Firma Dirección de División Adminsitrativa</label><br>
                        </div>
                    </div>
                </div>
                <div class="w3-col s4"> <!-- firma empleado -->
