...
<div id="formularioEmpleadoVisualizacion" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
        ...
        <header class="w3-container w3-deep-white">
            <div class="w3-bar" style="display: flex; justify-content: flex-start;">
                ...
                <div class="3-bar-item" style="display: flex; justify-content: space-between;">
                    ...
                    <span id="btnCerrarModalV" class="w3-btn w3-display-topright">&times;</span>
                </div>
            </div>
        ...
        <div class="w3-container w3-deep-white">
            <form id="formEmpleadoVisualizacion" enctype="multipart/form-data">
                <section>
                    ...
                    <input class="w3-input w3-border" name="tipoEmpleado" id="tipoEmpleado" type="text" placeholder="Ingrese el correo electronico del empleado">
                    <label class="w3-text-purple">Adscripción <span style="color:orangered;">*</span></label>
                    <input class="w3-input w3-border" name="adscripcion" id="adscripcion" type="text" placeholder="Ingrese el correo electronico del empleado">
                    <label class="w3-text-purple">Tipo de contrato <span style="color:orangered;">*</span></label>
                    <input class="w3-input w3-border" name="tipoCont" id="tipoCont" type="text" placeholder="Ingrese el correo electronico del empleado">
                    <label class="w3-text-purple">Categoría <span style="color:orangered;">*</span></label>
                    <input class="w3-input w3-border" name="categoria" id="categoria" type="text" placeholder="Ingrese el correo electronico del empleado">
                    ...
                    <input class="w3-input w3-border" name="horario" id="horario" type="text" placeholder="Ingrese el correo electronico del empleado">
                    </div>
...
<script>
    // Obtener una referencia al botón de cerrado
    var btnCerrarModalV = document.getElementById("btnCerrarModalV");

    // Agregar un controlador de eventos para el evento "click"
    btnCerrarModalV.addEventListener("click", function() {
